...
class TeaPage extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage('lib/images/tea.png'), fit: BoxFit.cover),
              ),
            ),
            const SizedBox(
              height: 30,
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                width: 230,
                decoration:
                    BoxDecoration(color: Color.fromRGBO(91, 212, 84, 1),
                    borderRadius: BorderRadius.circular(10),),
                child: Center(
                  child: Text(
  ...
  onTap: () {
            ...
            child:Container(
              height: 55,
              width: 250,
              decoration: BoxDecoration(color: Color.fromARGB(255, 9, 58, 7),
              borderRadius: BorderRadius.circular(10)),
              child: Center(
                child: Text(
                  "Back to Home page",
